...
<form method="post" action="">
    <div <%--class="panel admin-panel"--%>>
        <div class="padding border-bottom">
            <ul class="search">
                <li>
                    <a href="berth_add.jsp" class="button border-green">新增</a>
                </li>
            </ul>
        </div>
        <table class="table table-hover text-center" id="berth-table">
            <tr>
                <th>id</th>
                <th>老人id</th>
                <th>姓名</th>
                    ...
                    if (json.status == 200) {
                        for (let i = 0; i < json.message.length; i++) {
                            str = "<tr>" +
                                ...
                                "<td>" + json.message[i].ridgepole + "</td>" +
                                "<td>" + json.message[i].floor + "</td>" +
                                "<td>" + json.message[i].building + "</td>" +
                                "<td>" + json.message[i].berth + "</td>" +
        ...
        $.ajax(
            {
                ...
                dataType: "JSON",
                success: function (json) {
                    location.href='berth_update.jsp';
                },
                error: function (xhr) {
                    window.parent.location.href="/user/exit";
                    alert("会话已结束，请重新登录！");
