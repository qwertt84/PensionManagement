...
<form method="post" action="">
    <div <%--class="panel admin-panel"--%>>
        <div class="padding border-bottom">
            <ul class="search">
                <li>
                    <a href="malfunction_add.jsp" class="button border-green">新增</a>
                </li>
            </ul>
        </div>
        <table class="table table-hover text-center" id="malfunction-table">
            <tr>
                <th>id</th>
                <th>事故类型</th>
                <th>事故内容</th>
        ...
        $.ajax(
            {
                ...
                dataType: "JSON",
                success: function (json) {
                    location.href='malfunction_update.jsp';
                },
                error: function (xhr) {
                    window.parent.location.href="/user/exit";
                    alert("会话已结束，请重新登录！");
            ...
            $.ajax(
                {
                    ...
                    dataType: "JSON",
                    success: function (json) {
                        location.href='malfunction_table.jsp';
                    },
                    error: function (xhr) {
                        window.parent.location.href="/user/exit";
                        alert("会话已结束，请重新登录！");
