...
<div class="leftnav">
    ...
    <ul style="display:block;">
        <li><a href="notice_table.jsp" target="right"><span class="icon-caret-right"></span>系统公告</a></li>
        <li><a href="older_table.jsp" target="right"><span class="icon-caret-right"></span>老人信息</a></li>
        <li><a href="older_status_table.jsp" target="right"><span class="icon-caret-right"></span>老人状态信息</a></li>
        <li><a href="malfunction_table.jsp" target="right"><span class="icon-caret-right"></span>事故记录</a></li>
        <li><a href="cost_table.jsp" target="right"><span class="icon-caret-right"></span>入住费用</a></li>
        <li><a href="workers_table.jsp" target="right"><span class="icon-caret-right"></span>护工信息</a></li>
        <li><a href="complain_table.jsp" target="right"><span class="icon-caret-right"></span>投诉</a></li>
    </ul>
