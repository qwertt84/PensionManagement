...
<div class="<%--panel admin-panel--%>">
    <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加老人状态</strong></div>
    <div class="body-content">
        <form class="form-x" id="form-notice">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="radio" value="O型" name="blood_type" checked="checked">O型
            ...
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <input type="radio" value="不吸烟" name="smoke" checked="checked">不吸烟
                    <div class="tips"></div>
                </div>
            </div>
          <%--  <div class="form-group">
...
<script type="text/javascript">
  ...
  /*      let blood_type=$("#blood_type").val();*/
        ...
        if(olderid.length>0&&name.length>0&&height.length>0&&weight.length>0&&blood_type.length>0&&allergy.length>0&&heart_rate.length>0&&blood_pressure.length>0&&blood_sugar.length>0&&smoke.length>0) {
            $.ajax(
                {
                    url: "/olderstatus/add",
                    type: "POST",
                    data: {"olderid":olderid,"name":name,"height":height,"weight":weight,"blood_type":blood_type,"allergy":allergy,"heart_rate":heart_rate,"blood_pressure":blood_pressure,"blood_sugar":blood_sugar,"smoke":smoke},
                    dataType: "JSON",
                    success: function (json) {
                        if(json.status==200)
                        {
