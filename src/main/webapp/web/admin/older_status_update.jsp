...
<script type="text/javascript">
   ...
   /*     let smoke=$("#smoke").val();*/
        ...
        if(name.length>0&&height.length>0&&weight.length>0&&blood_type.length>0&&allergy.length>0&&heart_rate.length>0&&blood_pressure.length>0&&blood_sugar.length>0&&smoke.length>0) {
            $.ajax(
                {
