...
<div class="leftnav">
    ...
    <ul style="display:block;">
        ...
        <li><a href="leave_table.jsp" target="right"><span class="icon-caret-right"></span>请假</a></li>
        <li><a href="salary_table.jsp" target="right"><span class="icon-caret-right"></span>查看薪资</a></li>
    </ul>
