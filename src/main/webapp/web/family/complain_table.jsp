...
<form method="post" action="">
    <div <%--class="panel admin-panel"--%>>
        <div class="padding border-bottom">
            <ul class="search">
                <li>
                    <a href="complain_add.jsp" class="button border-green">新增</a>
                </li>
            </ul>
        </div>
        <table class="table table-hover text-center" id="complain-table">
            <tr>
                <th>id</th>
                <th>投诉类型</th>
                <th>投诉内容</th>
        ...
        $.ajax(
            {
                ...
                dataType: "JSON",
                success: function (json) {
                    location.href='complain_update.jsp';
                },
                error: function (xhr) {
                    window.parent.location.href="/user/exit";
                    alert("会话已结束，请重新登录！");
